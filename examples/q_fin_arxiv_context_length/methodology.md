...
* **Sampling Params:** Temperature 0.6, Top-P 0.95, Top-K 20, Max Output 256 tokens. "Reasoning" was enabled.

**Benchmarking Process**
* Swept across 20 input chunk sizes, scaling from 500 to 10,000 tokens in 500-token increments.
* For each chunk size, I extracted a random text block of that length from all 100 articles.
* Ran a standard summarization prompt **"Generate a concise summary of the following article chunk: [chunk]"** across the batch. 
